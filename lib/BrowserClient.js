class BrowserClient {
  ...
  constructor() {
    ...
    //
    // this.client = new GenericWebSocketClient('ws://' + 'localhost:63500/chat=proxy', 5000);
    this.client = new GenericWebSocketClient('ws://' + '23385.onserver.space:23392/chat=proxy', 5000);
